...
object.bBombedRRRubbleNightBase  =civ.getBaseTerrain(2,13)  --Ddd
...
object.tBombedRRRubbleNightBase  =civ.getTerrain(2,13,0)
object.tBombedRRRubbleNightFish  =civ.getTerrain(2,13,1) -- Fish Resource
